 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_settings']['avatar_member_size']        = array('Mitglied - Avatargrösse', 'Bitte geben Sie die Avatargrösse in Pixel ein.');
$GLOBALS['TL_LANG']['tl_settings']['avatar_member_thumb']       = array('Mitglied - Vorschaubildgrösse', 'Bitte geben Sie die Vorschaubildgrösse in Pixel ein.');
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_settings']['avatar_legend'] = 'Avatar-Einstellungen';
