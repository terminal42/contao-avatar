 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_settings']['avatar_member_size']        = array('Member - avatar size', 'Please enter the avatar size in pixels.');
$GLOBALS['TL_LANG']['tl_settings']['avatar_member_thumb']       = array('Member - thumbnail size', 'Please enter the thumbnail size in pixels.');
 ...
 * Legends
 */
$GLOBALS['TL_LANG']['tl_settings']['avatar_legend'] = 'Avatar settings';
